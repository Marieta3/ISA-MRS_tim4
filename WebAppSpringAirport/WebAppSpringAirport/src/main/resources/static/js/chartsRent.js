...
function drawChart3_1() {
    ...
    dataT.addColumn('number', 'Reserved cars');

	var day = $("#dayChart3").val();
	$.ajax({
		type:'POST',
		url:'/api/rentACars/chart3/daily/' + localStorage.getItem("rent_id"),
		dataType:'json',
		...
		success:function(data){
		    ...
		    var options = {
		      title: 'Cars reserved on selected day',
			  chartArea: {width: '50%'},
...
function drawChart3_2() {
    ...
    dataT.addColumn('number', 'Reserved vehicles');

	var day = $("#weekChart3").val();
	$.ajax({
		type:'POST',
		url:'/api/rentACars/chart3/weekly/' + localStorage.getItem("rent_id"),
		dataType:'json',
		...
		success:function(data){
		    ...
		    var options = {
		      title: 'Vehicles reserved in selected week',
			  chartArea: {width: '50%'},
...
function drawChart3_3() {
    ...
    dataT.addColumn('number', 'Cars reserved');

	var day = $("#dayChart3").val();
	$.ajax({
		type:'POST',
		url:'/api/rentACars/chart3/monthly/' + localStorage.getItem("rent_id"),
		dataType:'json',
		...
		success:function(data){
		    ...
		    dataT.addRows(arr);
		    var options = {
		      title: 'Tickets sold in selected month',
			  chartArea: {width: '50%'},
