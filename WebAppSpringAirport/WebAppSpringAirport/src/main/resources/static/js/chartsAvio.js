...
function drawChart3_1() {
    ...
    dataT.addColumn('number', 'Tickets sold');

	var day = $("#dayChart3").val();
	$.ajax({
		type:'POST',
		url:'/api/avioKompanije/chart3/daily/' + localStorage.getItem("avio_id"),
		dataType:'json',
		...
		success:function(data){
		    ...
		    var options = {
		      title: 'Tickets sold on selected day',
			  chartArea: {width: '50%'},
...
function drawChart3_2() {
	...
	$.ajax({
		type:'POST',
		url:'/api/avioKompanije/chart3/weekly/' + localStorage.getItem("avio_id"),
		dataType:'json',
		...
		success:function(data){
		    ...
		    var options = {
		      title: 'Tickets sold in selected week',
			  chartArea: {width: '50%'},
...
function drawChart3_3() {
	...
	$.ajax({
		type:'POST',
		url:'/api/avioKompanije/chart3/monthly/' + localStorage.getItem("avio_id"),
		dataType:'json',
