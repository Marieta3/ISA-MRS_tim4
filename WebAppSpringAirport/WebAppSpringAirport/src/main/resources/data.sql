...
INSERT INTO LET (id,pocetna_destinacija,krajnja_destinacija,vreme_polaska,vreme_dolaska,duzina_putovanja,model,broj_redova, broj_kolona,broj_redovaEC,broj_redovaBC,broj_redovaFC,avio_kompanija_id, cenafc, cenaec, cenabc) VALUES(1,'Belgrade','Paris','2019-07-14 15:45:32','2019-07-14 18:45:32',320,'Airbus A380',3,2,1,1,1,1, 100, 40, 90);
INSERT INTO LET (id,pocetna_destinacija,krajnja_destinacija,vreme_polaska,vreme_dolaska,duzina_putovanja,model,broj_redova, broj_kolona,broj_redovaEC,broj_redovaBC,broj_redovaFC,avio_kompanija_id, cenafc, cenaec, cenabc) VALUES(2,'Paris','Belgrade','2019-07-18 16:40:22','2019-07-18 18:40:22',320,'MiG 21',5,5,3,1,1,1, 100, 40, 90);
INSERT INTO LET (id,pocetna_destinacija,krajnja_destinacija,vreme_polaska,vreme_dolaska,duzina_putovanja,model,broj_redova, broj_kolona,broj_redovaEC,broj_redovaBC,broj_redovaFC,avio_kompanija_id, cenafc, cenaec, cenabc) VALUES(3,'London','Belgrade','2019-07-20 14:00:00','2019-07-20 18:00:00',620,'Boeing 747',9,9,5,3,1,2, 100, 40, 90);
INSERT INTO LET (id,pocetna_destinacija,krajnja_destinacija,vreme_polaska,vreme_dolaska,duzina_putovanja,model,broj_redova, broj_kolona,broj_redovaEC,broj_redovaBC,broj_redovaFC,avio_kompanija_id, cenafc, cenaec, cenabc) VALUES(4,'Dubai','Belgrade','2019-07-21 19:00:00','2019-07-22 00:00:00',800,'Boeing 737',8,8,4,3,1,1, 100, 40, 90);
INSERT INTO LET (id,pocetna_destinacija,krajnja_destinacija,vreme_polaska,vreme_dolaska,duzina_putovanja,model,broj_redova, broj_kolona,broj_redovaEC,broj_redovaBC,broj_redovaFC,avio_kompanija_id, cenafc, cenaec, cenabc) VALUES(5,'Belgrade','Dubai','2019-07-23 19:00:00','2019-07-23 23:50:00',800,'Boeing 737',8,8,4,3,1,1, 100, 40, 90);
INSERT INTO LET (id,pocetna_destinacija,krajnja_destinacija,vreme_polaska,vreme_dolaska,duzina_putovanja,model,broj_redova, broj_kolona,broj_redovaEC,broj_redovaBC,broj_redovaFC,avio_kompanija_id, cenafc, cenaec, cenabc) VALUES(6,'Belgrade','Paris','2019-04-14 15:45:32','2019-04-14 18:45:32',320,'Airbus A380',3,2,1,1,1,1, 100, 40, 90);
...
INSERT INTO bodovanje(id, km_za_broj, max_broj) VALUES (1,100,50);
